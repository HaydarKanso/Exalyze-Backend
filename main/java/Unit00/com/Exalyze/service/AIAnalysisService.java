...
import Unit00.com.Exalyze.dto.NumericSummaryDto;
...
public class AIAnalysisService {
    ...
    public Unit00.com.Exalyze.dto.ChartDataDto getChartData(List<Map<String, Object>> excelData) {
        if (excelData == null || excelData.isEmpty()) {
            return new Unit00.com.Exalyze.dto.ChartDataDto();
        }

        Unit00.com.Exalyze.dto.ChartDataDto dto = new Unit00.com.Exalyze.dto.ChartDataDto();
        Set<String> allColumns = excelData.get(0).keySet();
        Map<String, Unit00.com.Exalyze.dto.NumericSummaryDto> numericSummaries = new HashMap<>();
    ...
    private Unit00.com.Exalyze.dto.NumericSummaryDto calculateNumericSummary(List<Double> values) {
        Unit00.com.Exalyze.dto.NumericSummaryDto summary = new Unit00.com.Exalyze.dto.NumericSummaryDto();
        if (values.isEmpty()) {
            return summary;
        }
        Collections.sort(values);
    ...
    private List<Unit00.com.Exalyze.Bin> createHistogramBins(List<Double> values) {
        ...
        if (binSize == 0) {
            Unit00.com.Exalyze.Bin bin = new Unit00.com.Exalyze.Bin();
            bin.setLabel(String.format("%.2f", min));
            bin.setCount(values.size());
            return Collections.singletonList(bin);
        }
        List<Unit00.com.Exalyze.Bin> bins = new ArrayList<>(numBins);
